exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    //event table seed
    knex('eventsTable').insert({name: 1, date: "21/10",time: "10:00" ,description: "party at my house", }),
    knex('eventsTable').insert({name: 2, date: "30/11",time: "23:00",description: "party at my house", }),
    knex('eventsTable').insert({name: 3, date: "20/12",time: "20:00" ,description: "party at my house", })
  );
  );
};
